      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200/80 pb-6">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-zinc-900 tracking-tight">
            Collab Manager Applications
          </h1>
          <p className="text-xs text-zinc-500 font-normal">
            Track pitch proposals and whitelist allocation requests submitted on behalf of client projects.
          </p>
        </div>

        <Link
          href="/cm/opportunities"
        ...
        >
          <span>Pitch Open Campaigns</span>
      ...
      <div className="p-6 bg-white border border-zinc-200/80 shadow-2xs space-y-6">
        <div className="flex items-center justify-between border-b border-zinc-100 pb-4">
          <div className="flex items-center gap-2 text-xs font-semibold text-zinc-900">
            ...
            <span>Pitched Applications ({applications.length})</span>
          </div>
        </div>
        ...
        <div className="divide-y divide-zinc-100">
          {applications.length > 0 ? (
            ...
            <div className="py-12 text-center space-y-3">
              ...
              <p className="text-sm font-semibold text-zinc-700">No manager pitches submitted yet</p>
              <p className="text-xs text-zinc-400">
                Browse client opportunities to pitch projects for whitelist spot allocations.
              </p>
            </div>
          )}
        </div>
