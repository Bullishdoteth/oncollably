...
export default function PublicProjectPage({ params }: PageProps) {
  ...
  const [selectedCampaign, setSelectedCampaign] = useState<string>("Guaranteed Whitelist Allocation")
            ...
            <div className="max-w-5xl mx-auto px-6 sm:px-8 h-20 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-white hover:bg-zinc-100 text-zinc-900 text-xs font-bold shadow-sm hover:shadow-md transition-all flex items-center gap-1.5 cursor-pointer"
                >
              ...
              <form onSubmit={handleApplySubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      onChange={(e) => setAppForm({ ...appForm, communityType: e.target.value })}
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) => setAppForm({ ...appForm, cmHandle: e.target.value })}
