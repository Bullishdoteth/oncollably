  ...
  return (
    <section id="features" className="scroll-mt-20 relative overflow-hidden py-16 sm:py-24 lg:py-32 border-t border-zinc-100 bg-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-12 sm:space-y-16">
        ...
        <div className="bg-white rounded-3xl border border-zinc-200 shadow-xl overflow-hidden p-6 sm:p-10 lg:p-12 space-y-8 sm:space-y-10">
              ...
              {categories.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`px-5 py-2.5 rounded-full transition-all duration-200 cursor-pointer shrink-0 flex items-center gap-2 ${
                      isActive
          ...
          {/* Dynamic 2-Column Layout: 70% content, 30% full-height portrait video */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch animate-in fade-in duration-300">
