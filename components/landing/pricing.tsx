  ...
  return (
    <section id="pricing" className="scroll-mt-20 relative overflow-hidden py-16 sm:py-24 lg:py-32 border-t border-zinc-100 bg-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-12">
        {/* Header & Free platform badge aligned */}
        <motion.div
        ...
        >
          <div className="space-y-3 max-w-2xl">
            ...
            <p className="text-lg sm:text-xl text-zinc-600 font-normal leading-relaxed">
              Oncollably is 100% free to support Web3 projects, communities, and collab managers.
            </p>
          </div>

          <div className="shrink-0 flex items-center">
            <span className="inline-flex items-center gap-3 px-5 py-2.5 bg-emerald-950 text-emerald-300 font-semibold text-sm rounded-full shadow-md border border-emerald-800">
        ...
        >
          ...
          <div className="p-8 sm:p-10 lg:p-12 flex flex-col justify-between space-y-8 bg-zinc-50/50">
            <div className="space-y-6">
              ...
              <p className="text-sm text-zinc-600 leading-relaxed border-b border-zinc-200 pb-6">
                Unlock all collaboration management tools with zero platform fees. No recurring subscriptions, project creation fees, or hidden costs.
              </p>
            ...
            <div className="pt-4">
              ...
              >
                Get Started Oncollably for Free
              </Link>
            </div>
          </div>
          ...
          <div className="p-8 sm:p-10 lg:p-12 bg-black text-white flex flex-col justify-between space-y-8 relative overflow-hidden">
            ...
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-emerald-900/20 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="space-y-8 relative z-10">
              <div className="space-y-3">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-white leading-snug">
                  Built for seamless Web3 collaborations — 100% Free.
                </h3>
              </div>

              <div className="space-y-4 text-zinc-300 text-sm sm:text-base leading-relaxed">
                <p>
                  Web3 projects shouldn't be bogged down by recurring SaaS subscriptions or high setup fees just to handle partnerships and whitelist allocation.
                </p>
                <p>
                  With Oncollably being <strong className="text-white font-semibold">100% free</strong>, you gain immediate access to a unified system that eliminates chaotic Discord DMs, lost spreadsheets, and unverified collab proposals.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-zinc-800">
                {[
                  { title: "100% Free", desc: "No subscriptions, creation fees, or hidden charges." },
            ...
            <div className="pt-4 border-t border-zinc-800/80 flex items-center justify-between text-xs text-zinc-400 relative z-10">
              ...
              <span className="font-semibold text-zinc-300">100% Transparent & Free</span>
            </div>
          </div>
        </motion.div>
      </div>
